...
import { EventEmitter, ElementRef, Renderer, ChangeDetectorRef, TemplateRef, OnChanges } from '@angular/core';
...
export declare class NglLookup implements OnChanges {
    ...
    constructor(element: ElementRef, renderer: Renderer, detector: ChangeDetectorRef);
